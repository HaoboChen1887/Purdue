...
add wave -noupdate /system_tb/DUT/CPU/DP/brnaddr
...
add wave -noupdate -expand -group register -radix unsigned /system_tb/DUT/CPU/DP/rfif/rsel1
add wave -noupdate -expand -group register -radix unsigned /system_tb/DUT/CPU/DP/rfif/rsel2
...
add wave -noupdate -expand -group alu /system_tb/DUT/CPU/DP/aluif/ov
add wave -noupdate -expand -group alu /system_tb/DUT/CPU/DP/aluif/neg
add wave -noupdate -expand -group alu -radix binary /system_tb/DUT/CPU/DP/aluif/aluop
...
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/ihit
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/dhit
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/memreg_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/jmp_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/brn_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/bne_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/jr_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/halt_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/WEN_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/dREN_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/dWEN_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/jmpaddr_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/npc_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/jraddr_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/brnaddr_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/wsel_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/rdat2_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/port_o_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/zero_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/ov_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/neg_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/freeze
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/flush
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/instr_in
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/jmp_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/brn_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/bne_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/jr_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/memreg_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/halt_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/WEN_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/dREN_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/dWEN_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/jmpaddr_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/npc_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/jraddr_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/brnaddr_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/wsel_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/rdat2_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/port_o_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/zero_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/ov_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/neg_out
add wave -noupdate -expand -group exmem /system_tb/DUT/CPU/DP/emif/instr_out
...
add wave -noupdate -expand -group forward -radix unsigned /system_tb/DUT/CPU/DP/fuif/rs
add wave -noupdate -expand -group forward -radix unsigned /system_tb/DUT/CPU/DP/fuif/rt
add wave -noupdate -expand -group forward -radix unsigned /system_tb/DUT/CPU/DP/fuif/memwsel
add wave -noupdate -expand -group forward -radix unsigned /system_tb/DUT/CPU/DP/fuif/wbwsel
add wave -noupdate -expand -group forward /system_tb/DUT/CPU/DP/fuif/memWEN
add wave -noupdate -expand -group forward /system_tb/DUT/CPU/DP/fuif/wbWEN
add wave -noupdate -expand -group forward /system_tb/DUT/CPU/DP/fuif/exinstr
add wave -noupdate -expand -group forward -radix binary /system_tb/DUT/CPU/DP/fuif/forwarda
add wave -noupdate -expand -group forward -radix binary /system_tb/DUT/CPU/DP/fuif/forwardb
TreeUpdate [SetDefaultTree]
quietly WaveActivateNextPane
add wave -noupdate -expand -group memory /system_tb/DUT/CPU/DP/dpif/halt
add wave -noupdate -expand -group memory /system_tb/DUT/CPU/DP/dpif/ihit
add wave -noupdate -expand -group memory /system_tb/DUT/CPU/DP/dpif/imemREN
add wave -noupdate -expand -group memory /system_tb/DUT/CPU/DP/dpif/imemload
add wave -noupdate -expand -group memory /system_tb/DUT/CPU/DP/dpif/imemaddr
add wave -noupdate -expand -group memory /system_tb/DUT/CPU/DP/dpif/dhit
add wave -noupdate -expand -group memory /system_tb/DUT/CPU/DP/dpif/dmemREN
add wave -noupdate -expand -group memory /system_tb/DUT/CPU/DP/dpif/dmemWEN
add wave -noupdate -expand -group memory /system_tb/DUT/CPU/DP/dpif/flushed
add wave -noupdate -expand -group memory /system_tb/DUT/CPU/DP/dpif/dmemload
add wave -noupdate -expand -group memory /system_tb/DUT/CPU/DP/dpif/dmemstore
add wave -noupdate -expand -group memory /system_tb/DUT/CPU/DP/dpif/dmemaddr
TreeUpdate [SetDefaultTree]
quietly WaveActivateNextPane
add wave -noupdate -expand /system_tb/DUT/CPU/DP/RF/val
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {741641 ps} 0} {{Cursor 2} {575955 ps} 0} {{Cursor 3} {682467 ps} 0}
