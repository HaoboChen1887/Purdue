...
functionNames = ["getUrlParts", "getQueryParameters", "getSpecial", "getRealMAC", "getRejectedEntries",
                 "getEmployeesWithIDs", "getEmployeesWithoutIDs", "getEmployeesWithPhones", "getEmployeesWithStates",
                 "getCompleteEntries"]

# Attempt to import the code, and fail otherwise.
try:
    import regexApp as student
except:
    print("-------------------------------")
